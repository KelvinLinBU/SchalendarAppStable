...
class NorthActivity : AppCompatActivity(),SensorEventListener,GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text = findViewById<TextView>(R.id.North) as TextView
        setUpSensorStuff()
        ...
        when(event?.action){
            ...
            1->{
                ...
                if(Math.abs(dX)> MIN_DISTANCE){
                    ...
                    if(y2>y1){
                        startActivity(Intent(this@NorthActivity, MainActivity::class.java))
                    }
                    else{
