...
class EastActivity : AppCompatActivity(),SensorEventListener,GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text = findViewById<TextView>(R.id.East) as TextView
        setUpSensorStuff()
            ...
            1->{
                ...
                if(Math.abs(dX)> MIN_DISTANCE){
                    if(x2>x1){
                        ...
                        startActivity(Intent(this@EastActivity, MainActivity::class.java))
                    }
                }
