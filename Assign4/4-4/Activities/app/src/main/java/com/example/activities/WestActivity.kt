...
class WestActivity : AppCompatActivity(),SensorEventListener,GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text = findViewById<TextView>(R.id.West) as TextView
        setUpSensorStuff()
        ...
        when(event?.action){
            ...
            1->{
                ...
                if(Math.abs(dX)> MIN_DISTANCE){
                    if(x2>x1){
                        startActivity(Intent(this@WestActivity, MainActivity::class.java))
                    }
                    else{
